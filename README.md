...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py-cordex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14331&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-cordex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py-cordex` can be installed with:

```
conda install py-cordex
```

It is possible to list all of the versions of `py-cordex` available on your platform with:
